<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productstyle.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    <td class="left">Tên Kiểu Dáng
                    </td>
                    <td>
                        <asp:RadTextBox ID="txtSearchProductStyleName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductStyleID" runat="server" Value='<%# Eval("ProductStyleID") %>' />
                            <asp:HiddenField ID="hdnProductStyleImage" runat="server" Value='<%# Eval("ProductStyleImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductStyleID" SortExpression="ProductStyleID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Kiểu Dáng" DataField="ProductStyleName"
                        SortExpression="ProductStyleName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStyleName" runat="server" Text='<%# Eval("ProductStyleName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Kiểu Dáng(Tiếng Anh)" Visible="false"
                        DataField="ProductStyleNameEn" SortExpression="ProductStyleNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductStyleNameEn" runat="server" Text='<%# Eval("ProductStyleNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductStyleImage" HeaderText="Ảnh"
                        SortExpression="ProductStyleImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductStyleImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductStyle/" + Eval("ProductStyleImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductStyleImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductStyleID") + "#" + Eval("ProductStyleImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Kiểu Dáng</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductStyleID" runat="server" Value='<%# Eval("ProductStyleID") %>' />
                                        <asp:HiddenField ID="hdnProductStyleImage" runat="server" Value='<%# Eval("ProductStyleImage") %>' />
                                        <asp:RadUpload ID="FileProductStyleImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Kiểu Dáng
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductStyleName" runat="server" Text='<%# Bind("ProductStyleName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Kiểu Dáng(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductStyleNameEn" runat="server" Text='<%# Bind("ProductStyleNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Kiểu Dáng ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStyleName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Kiểu Dáng(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductStyleNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductStyleDelete"
        SelectMethod="ProductStyleSelectAll" TypeName="TLLib.ProductStyle" UpdateMethod="ProductStyleUpdate"
        InsertMethod="ProductStyleInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductStyleID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductStyleName" Type="String" />
            <asp:Parameter Name="ProductStyleNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductStyleName" Type="String" />
            <asp:Parameter Name="ProductStyleImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductStyleName" Name="ProductStyleName"
