<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="productmaterial.aspx.cs" Inherits="ad_single_partner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    ...
    <asp:RadAjaxPanel ID="RadAjaxPanel1" runat="server" ClientEvents-OnRequestStart="conditionalPostback">
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server" Visible="false">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductMaterialName" runat="server" Width="200px">
                        </asp:RadTextBox>
                    </td>
                </tr>
            </table>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                DataKeyNames="ProductMaterialID">
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderStyle-Width="1%" HeaderText="STT">
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdnProductMaterialID" runat="server" Value='<%# Eval("ProductMaterialID") %>' />
                            <asp:HiddenField ID="hdnProductMaterialImage" runat="server" Value='<%# Eval("ProductMaterialImage") %>' />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridBoundColumn HeaderText="ID" DataField="ProductMaterialID" SortExpression="ProductMaterialID" Visible="false">
                    </asp:GridBoundColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Chất Liệu" DataField="ProductMaterialName"
                        SortExpression="ProductMaterialName">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMaterialName" runat="server" Text='<%# Eval("ProductMaterialName")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    <asp:GridTemplateColumn HeaderText="Tên Chất Liệu(Tiếng Anh)" Visible="false"
                        DataField="ProductMaterialNameEn" SortExpression="ProductMaterialNameEn">
                        <ItemTemplate>
                            <asp:Label ID="lblProductMaterialNameEn" runat="server" Text='<%# Eval("ProductMaterialNameEn")%>'></asp:Label>
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                    ...
                    <asp:GridTemplateColumn DataField="ProductMaterialImage" HeaderText="Ảnh"
                        SortExpression="ProductMaterialImage" Visible="false">
                        <ItemTemplate>
                            <asp:Panel ID="Panel1" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ProductMaterialImage").ToString()) ? false : true %>'
                                Width="95">
                                <img alt="" src='<%# "~/res/ProductMaterial/" + Eval("ProductMaterialImage") %>' width="80"
                                    runat="server" visible='<%# string.IsNullOrEmpty(Eval("ProductMaterialImage").ToString()) ? false : true %>' />
                                <asp:LinkButton ID="lnkDeleteImage" runat="server" rel='<%#  Eval("ProductMaterialID") + "#" + Eval("ProductMaterialImage") %>'
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Chất Liệu</h3>
                            <table class="search">
                                <tr class="invisible">
                                    ...
                                    <td>
                                        <asp:HiddenField ID="hdnProductMaterialID" runat="server" Value='<%# Eval("ProductMaterialID") %>' />
                                        <asp:HiddenField ID="hdnProductMaterialImage" runat="server" Value='<%# Eval("ProductMaterialImage") %>' />
                                        <asp:RadUpload ID="FileProductMaterialImage" runat="server" ControlObjectsVisibility="None"
                                ...
                                <tr>
                                    <td class="left" valign="top">Tên Chất Liệu
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtProductMaterialName" runat="server" Text='<%# Bind("ProductMaterialName") %>'
                                ...
                                <asp:Panel ID="Panel2" runat="server" Visible="false">
                                    ...
                                    <tr>
                                        <td class="left" valign="top">Tên Chất Liệu(En)
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtProductMaterialNameEn" runat="server" Text='<%# Bind("ProductMaterialNameEn") %>'
                                                Width="500px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </asp:Panel>
        ...
        <asp:RadInputManager ID="RadInputManager1" runat="server">
            <asp:TextBoxSetting EmptyMessage="Tên Chất Liệu ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMaterialName" />
                </TargetControls>
            </asp:TextBoxSetting>
            <asp:TextBoxSetting EmptyMessage="Tên Chất Liệu(En) ...">
                <TargetControls>
                    <asp:TargetInput ControlID="txtProductMaterialNameEn" />
                </TargetControls>
            </asp:TextBoxSetting>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductMaterialDelete"
        SelectMethod="ProductMaterialSelectAll" TypeName="TLLib.ProductMaterial" UpdateMethod="ProductMaterialUpdate"
        InsertMethod="ProductMaterialInsert">
        <DeleteParameters>
            <asp:Parameter Name="ProductMaterialID" Type="String" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="ProductMaterialName" Type="String" />
            <asp:Parameter Name="ProductMaterialNameEn" Type="String" />
            <asp:Parameter Name="ConvertedProductMaterialName" Type="String" />
            <asp:Parameter Name="ProductMaterialImage" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="ProductID" Type="String" />
        </InsertParameters>
        <SelectParameters>
            <asp:ControlParameter ControlID="txtSearchProductMaterialName" Name="ProductMaterialName"
