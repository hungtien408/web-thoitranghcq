...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridBoundColumn DataField="ProductMaterialName" HeaderText="Chất Liệu" SortExpression="ProductMaterialName"/>
                    <asp:GridBoundColumn DataField="ProductStyleName" HeaderText="Kiểu Dáng" SortExpression="ProductStyleName"/>
                    ...
                    <asp:GridTemplateColumn DataField="IsBestSeller" HeaderText="Mua nhiều" SortExpression="IsBestSeller">
                        <ItemTemplate>
                    ...
                    <asp:GridTemplateColumn DataField="IsPopular" HeaderText="Ưa chuộng" SortExpression="IsPopular">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkIsPopular" runat="server" Checked='<%# string.IsNullOrEmpty(Eval("IsPopular").ToString()) ? false : Eval("IsPopular") %>'
                                CssClass="checkbox" />
                        </ItemTemplate>
                    </asp:GridTemplateColumn>
                                    ...
                                    <td valign="top">
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 283px x 283px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkIsBestSeller" runat="server" CssClass="checkbox" Text=" Mua nhiều"
                                                                Checked='<%# (Container is GridEditFormInsertItem) ? false : Eval("IsBestSeller") %>'/>
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkIsPopular" runat="server" CssClass="checkbox" Text=" Ưa chuộng"
                                                                Checked='<%# (Container is GridEditFormInsertItem) ? false : Eval("IsPopular") %>'/>
                                                            &nbsp;&nbsp;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductMaterial" runat="server" DataSourceID="odsProductMaterial"
                                                                DataTextField="ProductMaterialName" DataValueField="ProductMaterialID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadComboBox Filter="Contains" ID="ddlProductStyle" runat="server" DataSourceID="odsProductStyle"
                                                                DataTextField="ProductStyleName" DataValueField="ProductStyleID" Width="504px"
                                                                OnDataBound="DropDownList_DataBound" EmptyMessage="- Chọn -">
                                                            </asp:RadComboBox>
                                                        </td>
                                                    </tr>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:RadEditor ID="txtPolicy" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("Policy") %>'>
                                                                <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                    MaxUploadFileSize="1024000" />
                                                                <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtProductName"
                                            Display="Dynamic" ErrorMessage="Nhập tên sản phẩm" SetFocusOnError="true">*</asp:RequiredFieldValidator>--%>
                                                        ...
                                                        <td>
                                                            <asp:RadEditor ID="txtPolicyEn" ContentFilters="ConvertCharactersToEntities,ConvertToXhtml,OptimizeSpans,IndentHTMLContent,ConvertFontToSpan,IECleanAnchors,FixUlBoldItalic,RemoveScripts,FixEnclosingP"
                                                                runat="server" Language="vi-VN" Skin="Office2007" Width="503px" Content='<%# Bind("PolicyEn") %>'>
                                                                <ImageManager DeletePaths="~/Uploads/Image/" UploadPaths="~/Uploads/Image/" ViewPaths="~/Uploads/Image/"
                                                                    MaxUploadFileSize="1024000" />
                                                                <FlashManager DeletePaths="~/Uploads/Video/" UploadPaths="~/Uploads/Video/" ViewPaths="~/Uploads/Video/" />
                                                                <DocumentManager DeletePaths="~/Uploads/File/" UploadPaths="~/Uploads/File/" ViewPaths="~/Uploads/File/"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="ProductSelectAll1"
        TypeName="TLLib.Product" DeleteMethod="ProductDelete" InsertMethod="ProductInsert1"
        UpdateMethod="ProductUpdate1">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="Priority" Type="String" />
            <asp:Parameter Name="IsAvailable" Type="String" />
            <asp:Parameter Name="Policy" Type="String" />
            <asp:Parameter Name="PolicyEn" Type="String" />
        </InsertParameters>
        <SelectParameters>
    ...
    <asp:ObjectDataSource ID="odsProductStyle" runat="server" SelectMethod="ProductStyleSelectAll" TypeName="TLLib.ProductStyle">
        <SelectParameters>
