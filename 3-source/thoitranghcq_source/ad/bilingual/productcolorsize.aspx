...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <fieldset>
        <h3 class="searchTitle">Thông Tin Sản Phẩm</h3>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Màu Sắc" DataField="ProductOptionCategoryName" SortExpression="ProductOptionCategoryName">
                        <ItemTemplate>
                ...
                <EditFormSettings EditFormType="Template">
                    <FormTemplate>
                        <asp:Panel ID="Panel1" runat="server" DefaultButton="lnkUpdate">
                            <h3 class="searchTitle">Thông Tin Màu Sắc</h3>
                            <table class="search">
                                <tr class="invisible">
                                ...
                                <tr class="invisible">
                                    <td class="left" valign="top">Mã Màu
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="left" valign="top">Màu Sắc
                                    </td>
                                    <td>
                                        <asp:RadComboBox Filter="Contains" ID="ddlProductColor" runat="server" DataSourceID="odsProductColor"
                                            DataTextField="ProductColorName" DataValueField="ProductColorID" OnDataBound="DropDownList_DataBound"
