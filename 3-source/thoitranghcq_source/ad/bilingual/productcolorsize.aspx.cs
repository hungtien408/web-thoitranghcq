...
public partial class ad_single_servicecategory : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string ProductColorName = ((RadComboBox)row.FindControl("ddlProductColor")).SelectedItem.Text;
            string ProductColorID = ((RadComboBox)row.FindControl("ddlProductColor")).SelectedItem.Value;
            ...
            else
            {
                ...
                dsUpdateParam["ProductOptionCategoryName"].DefaultValue = ProductColorName;// strProductOptionCategoryName;
                ...
                dsUpdateParam["ProductColorID"].DefaultValue = ProductColorID;
